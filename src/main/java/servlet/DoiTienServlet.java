...
public class DoiTienServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String loaiTien = request.getParameter("loaingoaile");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>Kết quả đổi tiền</h2>");
            out.println("<p>Số tiền " + loaiTien + " bạn nhập: " + sotien + "</p>");
            out.println("<p>Số tiền Việt Nam tương ứng: " + ketQua + " VNĐ</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
